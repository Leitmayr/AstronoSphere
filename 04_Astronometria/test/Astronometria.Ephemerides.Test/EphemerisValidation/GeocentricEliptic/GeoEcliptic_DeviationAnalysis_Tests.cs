...
{
    [TestFixture]
    public class GeoEcliptic_DeviationAnalysis_Tests
    {
        ...
        public void Setup()
        {
            ...
            _vsopPath = Path.GetFullPath(
                Path.Combine(baseDir,
                    @"..\..\..\..\Astronometria.Ephemerides\VSOP\Data\87A"));
        }

        [Test]
        public void GenerateDeviationStatistics()
        {
            var baseDir = AppDomain.CurrentDomain.BaseDirectory;
            var dataPath = Path.Combine(baseDir,
                "EphemerisValidation", "TestData", "Geo");
            ...
            Assert.Pass("Deviation statistics generated.");
        }
        ...
        private static void WriteCsv(List<DeviationStatEntry> stats, string baseDir)
        {
            ...
            var path = Path.Combine(baseDir, "Geo_Deviation_Statistics.csv");
