...
public class SiderialTime : conversions 
{
		...
		// */
		//public SiderialTime( czeit arg_zeit );
		...
		// * @param arg_zeit new argument to calculate siderial time with
		// */
		//public void setSidTime( czeit arg_zeit );


		/**
		 * \brief returns the mean siderial time at Greenwich at 0 UT
		 */
		public double get_meanSidTime0 
		{
			get { return (_meanSidTime0); }
		}

	public double get_meanSidTime
	{
		get { return (_meanSidTime); }
	}

	/**
	 * \brief returns the apparent siderial time at Greenwich
	 */
	public double get_appSidTime
		{
	...
	protected void setSidTime(  czeit arg_zeit )
	{
		updateObject( arg_zeit );
	}
	...
	protected void updateObject( czeit arg_zeit )
	{
	...
	// --------------------------------------------------------------------------------------------------------------------------
	protected double calcMeanSiderealGreenwichTime0( czeit arg_zeit )
	{
		double loc_JD0 = arg_zeit.JD0;
		double T = ( loc_JD0 - astroConst.C__JD2000 )/astroConst.tage_pro_jahrhundert;
	...
	// --------------------------------------------------------------------------------------------------------------------------
	protected double calcMeanSiderealGreenwichTime(  czeit arg_zeit )
	{
		...
		double loc_UT = ohne_ueberlauf_hour( arg_zeit.UT.timeComma );
	...
	// --------------------------------------------------------------------------------------------------------------------------
	protected double calcAppSiderealGreenwichTime( czeit arg_zeit )
	{
