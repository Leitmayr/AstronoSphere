# Core_Draft_AstronoSphere_Diagnostics.md (M2.4)

---

## Status

Freeze Status: DRAFT  for M2.3/M2.4
Scope: Astronometria / AstronoTruth / AstronoSphere M2.4  

Needs extension for M2.4.9
...
| -------- | ------- | ---- |
| V1.0 | initial revision containing AstronoTruth and Astronometria  | 2026-06-23
...
>**Contents**
>✓ AstronoTruth 030.XX available and implemented. Introduced in M2.1
>✓ Astronometria 040.XX available and partially implemented. Introduced in M2.3.
...
>**Target Milestone:**
>- M2.4.9 AstronoDiag Consolidation
...
* execution policy (-> defined in owning component, e.g. Astronometria for 040.XX)
...
### 4.2 FMI (Failure Mode Identifier)

M2.4: needs cleanup and standardization 030/040 in later milestone.
...
#### 4.3.1 AstronoTruth (introduced M2.1) 
...
#### 4.3.2 Astronometria (introduced M2.3/M2.4) 

| Code    | Symbol                                 |
| ------- | -------------------------------------- |
| 040.002 | Astronometria.MultipleMatchingGroundTruth |
| 040.003 | Astronometria.InvalidExperimentMaturity |
| 040.004 | Astronometria.ProviderRangeViolation |
| 040.008 | Astronometria.UnsupportedScientificConfiguration |
| 040.009 | Astronometria.NoMatchingGroundTruthDatasetFound |


#### 4.3.3 Misc Codes (reserved for later)
...
### 6.2 Mapping Astronometria (M2.3)
