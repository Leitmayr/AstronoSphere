...
Epoche 1 (Core Zone): 1600–2400, Step 30d (inner and outer planets)
Epoche 2 (Extended Zone): 0–4000, Step 180d
Epoche 3 (Extreme Zone): -4000–8000, Step 2y

However, since this data range is not available for all planets in a heliocentric ecliptical reference system, the range is predetermined by the limitations in JPL-Horizons.

## Determination of the available ranges in Horizons

The minimum and maximum dates avaliable in Horizons were determined by means of dedicated API-requests outside the specified range, to achieve an error return from Horizons which tells about the borders:
...
These time intervals define the maximum range, planet specific.
...
## Mapping to the Epochs

### Mercury
Epoch1: 1.1.1600 ... 1.1.2400: steps 30d
Epoch2: 1.1.0000 ... 1.1.4000: steps 180d
Epoch3: 1.1.-4000 ... 1.1.8000: steps 720d
...
### Mars
Epoch1: 2.1.1600 ... 1.1.2400: steps 30d
Epoch2: 2.1.1600 ... 1.1.2600: steps 180d

### Jupiter
Epoch1: 11.1.1600 ... 9.1.2200: steps 30d

### Saturn
Epoch1: 31.12.1749 ... 5.1.2250: steps 30d

### Uranus
Epoch1: 5.1.1600 ... 16.12.2399: steps 30d

### Neptune
Epoch1: 5.1.1600 ... 1.1.2400: steps 30d

---

### Step Size

the last data point is not the last point in the data set. The last point is the end of the last full intervall inside the data set (t = N*30d for Epoch 1).
A data set can either be the epoch duration or the planet data set duration.
