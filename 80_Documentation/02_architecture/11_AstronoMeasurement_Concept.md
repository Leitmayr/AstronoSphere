...
- AstronoFactories (external reference generation)
...
- A **Scenario** defines *what* physical experiment is performed.
...
for the same scenario, for example:
...
A single scenario can therefore produce multiple datasets depending on
...
- scenarios remain stable and minimal
...
- Scenario defines the experiment
