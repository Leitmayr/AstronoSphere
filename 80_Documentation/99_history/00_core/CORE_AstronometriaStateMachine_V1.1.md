...
For this, in a first step, Astronometria must scan the GroundTruth files for the ExperimentID of the Experiment to find the corresponding file.
...
This is the priority in which evaluation shall be carried out in the algorithm:
