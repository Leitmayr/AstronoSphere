...
{
    public sealed class GeoQuadrantL0ExportRunner
    {
        public async Task RunAsync(IEnumerable<HelioEvent> events)
        {
            ...
            foreach (var e in events)
            {
                ...
                Console.WriteLine($"JSON Export GEO TS-A: {e.Planet} {e.EventName}");
            ...
            Console.WriteLine("Geo Quadrant L0 JSON export complete.");
        }
    }
}
